...
public class CheapFlightService {
    ...
    public HttpResponse<String> postFlightInfo(Root input) throws IOException, InterruptedException {
    ...
    public HttpResponse<String> getFlightInfoPoll() throws IOException, InterruptedException {
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create("https://skyscanner-api.p.rapidapi.com/v3/flights/live/search/poll/%7BsessionToken%7D"))
                .header("content-type", "application/json")
                .header("X-RapidAPI-Key", "f97aefd7aemsh71ad17ff2a959d1p14e65djsn82acd5d21dbb")
                .header("X-RapidAPI-Host", "skyscanner-api.p.rapidapi.com")
